...
class PrivateStageCliTests(unittest.TestCase):
    def test_portfolio_passes_explicit_private_directory(self):
        ...
        with tempfile.TemporaryDirectory() as raw, patch.object(cli, "load_dotenv"), patch.object(
            ...
            cli, "create_minute_snapshot_loader", return_value=sentinel_minute
        ) as minute_factory, patch.object(
            cli, "create_industry_provider", return_value=sentinel_industry
        ) as industry_factory, patch.object(
